...
To distinguish them from Gaussian integers with b â‰  0 we call such integers "rational integers."
...
Note also that if the Gaussian Integer (a+bi) is a divisor of a rational integer n, then its complex conjugate (aâˆ’bi) is also a divisor of n.
In fact, 5 has six divisors such that the real part is positive: {1, 1 + 2i, 1 âˆ’ 2i, 2 + i, 2 âˆ’ i, 5}.
